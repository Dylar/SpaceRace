...
class TestGl20 : GL20 {
    ...
    override fun glGenTexture(): Int = 0
    ...
    override fun glGetActiveAttrib(program: Int, index: Int, size: IntBuffer?, type: java.nio.Buffer?): String = ""

    override fun glGenFramebuffer(): Int = 0
    ...
    override fun glTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: java.nio.Buffer?) {
    ...
    override fun glCheckFramebufferStatus(target: Int): Int = 0
    ...
    override fun glIsRenderbuffer(renderbuffer: Int): Boolean = true
    ...
    override fun glIsFramebuffer(framebuffer: Int): Boolean = true
    ...
    override fun glCompressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: java.nio.Buffer?) {
    ...
    override fun glGenRenderbuffer(): Int = 0
    ...
    override fun glShaderBinary(n: Int, shaders: IntBuffer?, binaryformat: Int, binary: java.nio.Buffer?, length: Int) {
    ...
    override fun glGetActiveUniform(program: Int, index: Int, size: IntBuffer?, type: java.nio.Buffer?): String = ""

    override fun glClearColor(red: Float, green: Float, blue: Float, alpha: Float) {

    }

    override fun glIsShader(shader: Int): Boolean = true
    ...
    override fun glCreateProgram(): Int = 0
    ...
    override fun glTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: java.nio.Buffer?) {
    ...
    override fun glIsEnabled(cap: Int): Boolean = true
    ...
    override fun glIsBuffer(buffer: Int): Boolean = true
    ...
    override fun glIsProgram(program: Int): Boolean = true
    ...
    override fun glGetAttachedShaders(program: Int, maxcount: Int, count: java.nio.Buffer?, shaders: IntBuffer?) {
    ...
    override fun glIsTexture(texture: Int): Boolean = true
    ...
    override fun glCreateShader(type: Int): Int = 0
    ...
    override fun glCompressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: java.nio.Buffer?) {
    ...
    override fun glGenBuffer(): Int = 0
