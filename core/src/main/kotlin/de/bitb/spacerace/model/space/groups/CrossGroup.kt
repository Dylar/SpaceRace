...
class CrossGroup(offsetX: Float = 0f,
    ...
    init {
        ...
        //CENTER
        val centerField = FieldGraphic.createField(FieldType.GIFT)
        addField(centerField, SCREEN_WIDTH_HALF, SCREEN_HEIGHT_HALF)

        //LEFT
        val left1Field = FieldGraphic.createField(FieldType.MINE)
        addField(left1Field, centerField, -FIELD_PADDING_LARGE)
        val left2Field = FieldGraphic.createField(FieldType.WIN)
        ...
        //RIGHT
        val right1Field = FieldGraphic.createField(FieldType.AMBUSH)
        addField(right1Field, centerField, FIELD_PADDING_LARGE)
        val right2Field = FieldGraphic.createField(FieldType.SHOP)
        ...
        //BOTTOM
        val leftDown1Field = FieldGraphic.createField(FieldType.LOSE)
        addField(leftDown1Field, centerField, -FIELD_PADDING_MEDIUM, -FIELD_PADDING_LARGE)
        val leftDown2Field = FieldGraphic.createField(FieldType.WIN)
        ...
        val rightDown1Field = FieldGraphic.createField(FieldType.LOSE)
        addField(rightDown1Field, centerField, FIELD_PADDING_MEDIUM, -FIELD_PADDING_LARGE)
        val rightDown2Field = FieldGraphic.createField(FieldType.WIN)
