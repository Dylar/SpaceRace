...
class TestGroup(space: GameController, offsetX: Float = 0f, offsetY: Float = 0f) : SpaceGroup(space, offsetX, offsetY) {
    ...
    init {
        ...
        space.fieldController.addConnection(space, spaceField1, spaceField3)
        space.fieldController.addConnection(space, spaceField2, spaceField3)
        space.fieldController.addConnection(space, spaceField5, spaceField6)
        space.fieldController.addConnection(space, spaceField5, spaceField4)
        space.fieldController.addConnection(space, spaceField8, spaceField4)
        space.fieldController.addConnection(space, spaceField2, spaceField4)
        space.fieldController.addConnection(space, spaceField3, spaceField7)
        space.fieldController.addConnection(space, spaceField8, spaceField7)
        space.fieldController.addConnection(space, spaceField1, spaceField6)
        space.fieldController.addConnection(space, spaceField7, spaceField6)
        space.fieldController.addConnection(space, spaceField2, spaceField9)
