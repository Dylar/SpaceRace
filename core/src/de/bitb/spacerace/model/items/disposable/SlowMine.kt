...
class SlowMine(owner: PlayerColor, price: Int) : DisposableItem(TextureCollection.slowMine, ItemCollection.ION_ENGINE, owner, ITEM_ION_ENGINE_TEXT, price), DiceModification {
